...
public class CandidatoView extends ViewMaster {
	...
	public void insertScreen() {
		...
		JLabel id_label, numero_label, nome_label, nascimento_label, site_label, foto_label, partido_label, cargo_label, sexo_label, apelido_label, vice_nome_label, vice_foto_label;
		...
		vice_nome_input = new JTextField(); //inputError code: 32
		...
		vice_nome_input.addFocusListener(new FocusListener() {
			...
			public void focusLost(FocusEvent e) {
				...
				if(inputText.isEmpty()) {
					Display.setInactiveInputBorder(vice_nome_input);
					setInputError(32);
				} else {
