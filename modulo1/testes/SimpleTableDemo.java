...
public class SimpleTableDemo extends JPanel {
	...
	public SimpleTableDemo() {
		...
		insert = new JButton("Insert", Display.pathToImageIcon(DefaultFiles.imagePath + "insert.png"));
		...
		update = new JButton("Update", Display.pathToImageIcon(DefaultFiles.imagePath + "update.png"));
		...
		delete = new JButton("Delete", Display.pathToImageIcon(DefaultFiles.imagePath + "delete.png"));
	...
	public static void reloadTable(JTable table, List<Candidato> list, Candidato flag) {
		...
		for(i = 0; i < size; i++) {
			model.addRow(list.get(i).toString(true).split("\t"));
		}
	}
