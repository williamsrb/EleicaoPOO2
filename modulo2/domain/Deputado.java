...
public class Deputado extends Candidato {
	...
	public void setDisplay(JPanel pane) {
		...
		numDigit03 = new JLabel(String.format("%c", person.getNumero().toString().charAt(2)));
		...
		numDigit04 = new JLabel(String.format("%c", person.getNumero().toString().charAt(3)));
		...
		numDigit05 = new JLabel(String.format("%c", person.getNumero().toString().charAt(4)));
